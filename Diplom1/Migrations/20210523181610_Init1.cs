        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_DBRequests_DBCargo_CargoID",
                        column: x => x.CargoID,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RubPrice = table.Column<int>(type: "int", nullable: false),
                    UsdPrice = table.Column<int>(type: "int", nullable: false),
                    CargoObjectID = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_DBServices", x => x.ID);
                    table.ForeignKey(
                        name: "FK_DBServices_DBCargo_CargoObjectID",
                        column: x => x.CargoObjectID,
                        principalTable: "DBCargo",
                        principalColumn: "ID",
                        onDelete: ReferentialAction.Restrict);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DBRequests_CargoID",
                table: "DBRequests",
                column: "CargoID");

            migrationBuilder.CreateIndex(
                name: "IX_DBServices_CargoObjectID",
                table: "DBServices",
                column: "CargoObjectID");
        }
